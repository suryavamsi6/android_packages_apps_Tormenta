...
package com.lluvia.settings.preferences;
...
import com.lluvia.settings.preferences.ShortcutPickHelper;
import com.lluvia.settings.preferences.ActionPreference;
import com.lluvia.settings.preferences.CustomActionListAdapter;
...
public class ActionFragment extends SettingsPreferenceFragment implements
    ...
    public int getDialogMetricsCategory(int dialogId) {
        switch (dialogId) {
            case DIALOG_CATEGORY:
            case DIALOG_CUSTOM_ACTIONS:
                return MetricsEvent.LLUVIA_SETTINGS;
            default:
                return 0;
        }
    }
